...
export default {
    ...
    created() {
        //-------- load Fecha
        var $this = this;
        this.ruta = route("cotizacion.storeDocumento");
        var fecha = new Date();
    ...
    methods: {
        llenarDetalleCotizacion: function () {
            let $this=this
            console.log(this.cotizacion)
            this.cotizacion.detalle.forEach((value, index, array) => {
                $this.table.row
                    .add({
