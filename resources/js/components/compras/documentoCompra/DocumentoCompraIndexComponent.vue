...
export default {
    ...
    methods: {
        datosInicializado: function () {
            this.table = $("#tableDocumentosCompras").DataTable({
                bPaginate: true,
                bLengthChange: true,
                bFilter: true,
                bInfo: true,
                bAutoWidth: false,
                processing: true,
                ajax: route("documentoCompra.getList"),
                language: {
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        render: function (data) {
                            if (data.proveedor.persona.persona_dni != null) {
                                return (
                                    data.proveedor.persona.persona_dni
                                        .apellidos +
                                    " " +
                                    data.proveedor.persona.persona_dni.nombres
                                );
                            }
                            return data.proveedor.persona.persona_ruc
                                .nombre_comercial;
                        },
                    },
                    {
        ...
        goCreate: function () {
            window.location.href = route("documentoCompra.create");
        },
    },
};
</script>
