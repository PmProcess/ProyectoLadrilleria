...
export default {
    ...
    mounted() {
        ...
        $(document).on("click", ".btn-delete", function (e) {
            ...
            swal({
                ...
                if (willDelete) {
                    axios
                        .post(route("almacen.destroy", $this.id))
                        .then((value) => {
    ...
    methods: {
        ...
        datosInicializado: function () {
            this.table = $("#tableAlmacen").DataTable({
                bPaginate: true,
                bLengthChange: true,
                bFilter: true,
                bInfo: true,
        ...
        editAlamacen: function () {
            ...
            if (this.validaciones()) {
                ...
                axios
                    .post(route("almacen.update", $this.id), formdata)
                    .then((value) => {
                        if (value.data.success) {
                            $this.table.ajax.reload();
