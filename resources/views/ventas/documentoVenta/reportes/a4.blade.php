...
<body>
    ...
    <table
        class="table table-light table-light table-sm mt-3 {{ $opcion->table->tipo == 'striped' ? 'table-striped' : '' }} {{ $opcion->table->border ? 'table-bordered' : '' }}">
        <thead class="small"
            ...
            <tr>
                <th style="width:10%;text-align:center;border:solid {{ $opcion->table->header->borderColor }};
                    {{ $opcion->table->border ? 'border-width:1px 1px 1px 1px' : 'border-width:1px 0px 1px 0px' }}">
                    Cant</th>
    ...
    <p class="p-0 m-0 text-uppercase small">SON: <b>{{ $legends[0]['value'] }}</b></p>
    <br>
    <table class="tbl-qr">
        <tr>
